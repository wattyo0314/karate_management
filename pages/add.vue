      ...
      <v-container>
        <v-row>
          ...
          <ValidationObserver ref="observer" v-slot="{ invalid }" immediate>
            <v-form @submit.prevent="handleSubmit(login)" v-model="valid">
              ...
              <v-row class="ml-5" dense>
                <v-col cols="2">
                  <!-- 道場生姓名フリガナ入力 -->
                  <ValidationProvider v-slot="{ errors, valid }" name="フリガナ" rules="required|katakana">
                    <v-badge left color="error" content="必須">
                      <v-text-field
                      label="フリガナ"
                      outlined
              ...
              <v-row dense>
                ...
                <v-row dense>
                  ...
                  <ValidationProvider v-slot="{ errors, valid}" name="住所" rules="required">
                    <v-badge offset="" left color="error" content="必須" >
                      <v-text-field
                      label="住所・番地"
                      outlined
                      placeholder="長岡京市〇〇"
                ...
                <v-row dense>
                  <v-col justify="center" align="center">
                    <v-btn type="submit" color="success" :disabled="invalid">送信</v-btn>
                  </v-col>
                </v-row>
            </v-form>
        </ValidationObserver>
